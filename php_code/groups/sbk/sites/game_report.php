...
function checkPenalty(number)
{
	if (document.getElementsByName("code_" + number)[0].value != "0" && document.getElementsByName("strafe_" + number)[0].value == "0" )
	{
		alert("Zu jedem Strafcode muss eine Strafe eingegeben werden!");
		document.getElementsByName("strafe_" + number)[0].focus();
	}
}
</script>
<?php 
...
//   echo '<input id="b4rnc2" type="text" class="itext2" name="assh_'.$i.'" maxlength="3" value="" />'."\n";
   ...
   echo '</select>';
   echo '<select id="b4rnc7" class="itext2 generic-select" name="code_'.$i.'" size="1" onChange="checkPenalty('.$i.')">';
